...
public class RunningScoringActions implements Actions
{
    Timer timer;
    double seconds;
    double intakeSpeed;
    ...
    public RunningScoringActions (double seconds, double intakeSpeed, double rampSpeed, double outtakeSpeed)
    {
