...
public class DriverController extends XboxController implements Subsystem
{
    ...
    public boolean debounceLeftBumper()
    {
        if (getButton(ButtonMap.XboxB) && leftBumperReleased)
        {
        ...
        {
            leftBumperReleased = !getButton(ButtonMap.XboxB);
            return false;
        }
    }
